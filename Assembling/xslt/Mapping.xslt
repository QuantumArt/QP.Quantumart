...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="status_type">
    ...
    <Table xmlns="http://schemas.microsoft.com/linqtosql/dbml/2007" Name="STATUS_TYPE" Member="StatusTypes">
      <Type Name="StatusType">
        ...
        <Column Name="STATUS_TYPE_ID" Member="Id" Type="System.Int32" DbType="Decimal(18,0) NOT NULL IDENTITY"
                IsPrimaryKey="true" IsDbGenerated="true" CanBeNull="false" />
        <Column Name="STATUS_TYPE_NAME" Member="Name" Type="System.String" DbType="NVarChar(255) NOT NULL"
                CanBeNull="false" />
        ...
        <Column Name="LAST_MODIFIED_BY" Member="LastModifiedBy" Type="System.Int32" DbType="Decimal(18,0) NOT NULL"
                CanBeNull="false" />
      </Type>
    </Table>
  </xsl:template>
  ...
  <xsl:template match="content">
    <Table xmlns="http://schemas.microsoft.com/linqtosql/dbml/2007">
      ...
      <Type>
        ...
        <Column Name="CONTENT_ITEM_ID" Type="System.Int32" Member="Id" DbType="Decimal(18,0) IDENTITY NOT NULL"
                IsPrimaryKey="true" CanBeNull="false" IsDbGenerated="true" />
        <Column Name="STATUS_TYPE_ID" Type="System.Int32" Member="StatusTypeId" DbType="Decimal(18,0) NOT NULL"
                CanBeNull="false" />
        ...
        <Column Name="LAST_MODIFIED_BY" Type="System.Int32" Member="LastModifiedBy" DbType="Decimal(18,0) NOT NULL"
                CanBeNull="false" />
        ...
        <xsl:apply-templates
          ...
          mode="ImplicitBackAssociation">
        </xsl:apply-templates>

        <Association Name="StatusType_ContentItem" Member="StatusType" ThisKey="StatusTypeId" OtherKey="Id"
                     Type="StatusType" IsForeignKey="true" />
  ...
  <xsl:template match="link">
    <Table xmlns="http://schemas.microsoft.com/linqtosql/dbml/2007">
      ...
      <Type>
        ...
        <Column Name="ITEM_ID" Type="System.Int32" DbType="Decimal(18,0) NOT NULL" CanBeNull="false"
                IsPrimaryKey="true">
          <xsl:attribute name="Member">
        ...
        <Column Name="LINKED_ITEM_ID" Type="System.Int32" DbType="Decimal(18,0) NOT NULL" CanBeNull="false"
                IsPrimaryKey="true">
          <xsl:attribute name="Member">
  ...
  <xsl:template match="attribute" mode="ExplicitBackAssociation">
    ...
    <xsl:variable name="related_attribute_name">
      <xsl:value-of
        select="parent::node()/parent::node()/content[@id=$related_content_id]/attribute[@id=$related_attribute_id]/@mapped_name" />
    </xsl:variable>
